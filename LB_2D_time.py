...
class HDivSchurPC(AuxiliaryOperatorPC):
    ...
    def form(self, pc, v, u):
        ...
        Jp = lhs(utils.LB_velocity(velo, One, unph, w, bnph, pnp1, dt, no_rotation=True, twoD=True))
        Jp += lhs(utils.LB_buoyancy(b, Constant(1.), q, unph, dt, twoD=True))
        #  Boundary conditions
...
u0_slice, b0ic, p0ic = Un.subfunctions
u1_slice, b1ic, p1ic = Unp1.subfunctions
...
eqn = utils.LB_velocity(unp1, un, unph, wxz, bnph, pnp1, dt, no_rotation=True, twoD=True)
eqn += utils.LB_buoyancy(bnp1, bn, q, unph, dt, twoD=True)
...
params_schur = {
    ...
    'mat_view':'draw:tikz:fullmat_aux.tex',
    ...
    'fieldsplit_1': {
        ...
        # 'mat_view':'draw:tikz:field_1_mat_aux.tex',
        'pc_type': 'python',
...
#     print(f"=======================================The solver is currentlysolving for time:{t}==========================")
#     t += args.dt
#     tdump += args.dt
#     i += 1
#     nsolver.solve()
